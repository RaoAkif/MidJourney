      ...
      <View style={styles.storiesContainer}>
        ...
        <View style={styles.storyContainer}>
          <View style={styles.storyTextContainer}>
            ...
            <Text style={styles.storyDescription}>
              They set off to go north bound towards the mountains. Unaware of the fack that there has been ....
            </Text>
          </View>
        </View>
        <View style={styles.storyContainer}>
          <View style={styles.storyTextContainer}>
            ...
            <Text style={styles.storyDescription}>
              Why did the army decide to march forward instead of retreating and going back to ....
            </Text>
          </View>
        </View>
        <View>
          <Image style={styles.downArray} source={require("../../assets/down1.png")} />
        </View>
      </View>
    </View>
  );
